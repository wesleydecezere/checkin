...
export type AllEventsQuery = { __typename?: 'Query', events: Array<{ __typename?: 'Event', id: string, date: any } | null> };

export type AllPupilsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllPupilsQuery = { __typename?: 'Query', pupils: Array<{ __typename?: 'Pupil', id: string, name: string, grade: number, belt: BeltEnum, active: boolean } | null> };

export type AllCheckinsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllCheckinsQuery = { __typename?: 'Query', checkins: Array<{ __typename?: 'Checkin', id: string, eventId: string, participantId: string, date: any } | null> };
